...
class DbAccess(InterfaceBase, abc.ABC):
    ...
    def instantiate_schematic(self, lib_name, content_list, lib_path=''):
        ...
        print('bag.interface.database,lib_name_psh',lib_path)
        print('bag.interface.database,lib_path_psh',lib_path)
        print("bag.interface.database,template_list_psh",template_list)
