...
def run_main(prj):
    amp_dsn_specs_fname = 'specs_design_sample/diffamp_paper.yaml'
    amp_char_specs_fname = 'specs_char_sample/diffamp_paper.yaml'
    amp_char_specs_out_fname = 'specs_design_sample/diffamp_paper_mod.yaml'
